...
module.exports = {
     ...
     */
    botname: process.env.BotName || "ᥴ ᠻꪮ𝕣 ᥴꪖડⅈꪀꪮ",
    ...
    ownernumber: process.env.Owner_Number || "917012279397",
    ...
    sessionId: process.env.SESSION_ID || "MTtcO_A_N_Y_A_V_2_LGIZUBvKLXNekWA",
